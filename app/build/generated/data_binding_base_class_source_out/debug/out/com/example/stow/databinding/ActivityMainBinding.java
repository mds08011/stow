...
package com.example.stow.databinding;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnRecord,
      @NonNull ImageButton btnSettings, @NonNull TextView tvTranscription) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvTranscription;
      TextView tvTranscription = ViewBindings.findChildViewById(rootView, id);
      if (tvTranscription == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, btnRecord, btnSettings,
          tvTranscription);
    }
